...
AZURE_OPENAI_PREVIEW_API_VERSION = os.environ.get(
    "AZURE_OPENAI_PREVIEW_API_VERSION", "2023-03-15-preview")
...
def prepare_body_headers_with_data(request):
    ...
    if is_chat_model():
        chatgpt_url += f"/chat/completions?api-version={AZURE_OPENAI_PREVIEW_API_VERSION}"
    else:
        chatgpt_url += f"/completions?api-version={AZURE_OPENAI_PREVIEW_API_VERSION}"
...
def conversation_without_data(request):
    ...
    openai.api_version = f"{AZURE_OPENAI_PREVIEW_API_VERSION}"
